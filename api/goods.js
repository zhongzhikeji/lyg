...
//  * 获取分类商品
//  */
// export function getGoodsByClass(params) {
// 	return http.request({
// 		url: `/goods/goods/es`,
// 		method: Method.GET,
// 		params,
 ...
 * @param id 商品ID
 */
export function getGoodsInfos(id) {
	return http.request({
 ...
 * 收藏和关注
 */
export function addGoodsOrStore(type, id) {
	return http.request({
 ...
 *查询是否收藏和关注
 */
export function isAddGoodsOrStore(type, id) {
	return http.request({
		url: `/member/collection/isCollection/${type}/${id}`,
		method: Method.GET
	});
}
 ...
 *取消收藏
 */
export function deleteGoodsOrStore(type, id) {
	return http.request({
 ...
 *查询关注和收藏
 */
export function getGoodsOrStore(params) {
	return http.request({
 ...
 * 通告
 */
export function getMpTypee(params) {
	return http.request({
