<style scoped>
	.top-bg {
		height: 70vh;
		background-image: linear-gradient(#038E3D, rgba(255, 255, 255, 0));
	}
	...
	<view class="points">
		...
		<view class="page-padding">
			<view class="box ">
				...
				<view class="page-padding">
					<view class="top-68 row-between align-center title-box">
						<view class="bold">
							绿值变动明细
						</view>
					...
					<view class="record top-30">
						<view class="record-item row-between align-center top-24">
							<view class="">
								<view class="">
									平级奖
								</view>
